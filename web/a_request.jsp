			   ...
			   <center>
                       ...
                       <tr>
                           ...
                           <th style="color:#660066; font-size:23px;font:bolder" >File Name</th>
                                ...
                                <th style="color:#660066; font-size:23px;font:bolder">Authority Secret Key</th>
                               </tr>
                               <br></br>
                         <tr>
                                <%
...
String mail=user.getAttribute("email").toString(); 
            ...
            %>
                                ...
                                <td style="font-size:18px;font:bolder"><%=rs.getString("size")%></td>
                                 ...
                                 <td style="font-size:18px;font:bolder;"><a href="key_request.jsp?fname=<%=rs.getString("file_name")%>&email=<%=mail%>&size=<%=rs.getString("size")%>" >Request Key</a> </td>
                               </tr>
                            <%}
                                } catch (Exception ex) {
                                    ex.printStackTrace();
