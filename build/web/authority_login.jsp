...
<section>
                             ...
                             <center><fieldset style="background-color:cornflowerblue;border-radius: 9px;height: 350px;margin-top: 10px;">
                                 <br>
          <center>
        <h1 style="font: monospace;font-size: 35px;font-weight: bold;color:black">Team Leader Login</h1><br><br>
            <form action="authority_login" name="form1" method="post" onsubmit="return validation()"> 
<label style="font-size: 20px;margin-left:30px;">Team Leader-ID:</label> <br><input type="text" id="id"  style="height: 30px; width:250px; " name="name"required style="margin-left: 45px;" placeholder="Enter Email ID "/><br><br>
