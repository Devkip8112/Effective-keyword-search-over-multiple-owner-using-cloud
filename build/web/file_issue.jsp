...
<div class="dropdown">
                       <button class="dropbtn">Menu</button> 
                           <div class="dropdown-content">
                                <a href="trustee_page.jsp">Trustee Home</a>
										
							
							
							<a href="file_issue.jsp">File Security Response</a>
							<a href="trustee_login.jsp">Log Out</a>
...
<section>
	<div class="full-width-container block-2">
		<div class="container">
			 ...
			 <center>
                                <header>
						<h1 style="color:whitesmoke"><span>File Security Response </span></h1>
					</header>
					
                               </center>
			   <center>
                               <table border="8" width="1000px" hieght="1200px" style="text-align: center;background-color:#00e5ff">
            ...
            %>
                                ...
                                <td style="font-size:18px;font:bolder"><%=rs.getString("size")%></td>
                                 ...
                                 <td style="font-size:18px;font:bolder;color:whitesmoke"><a href="security_response.jsp?fname=<%=rs.getString("file_name")%>&email=<%=rs.getString("request")%>" >Response</a> </td>
                               </tr>
                            <%}
                                } catch (Exception ex) {
                                    ex.printStackTrace();
